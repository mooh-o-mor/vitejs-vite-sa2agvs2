...
/* ── Водные объекты и проливы — без префикса "п." ── */
const WATER_BODY = /^(керченский пролив|балтийское море|охотское море|берингово море|японское море|каспийское море|черное море|азовское море)/i;
...
export function extractLocation(raw: string): string {
  ...
  // 11. Восстанавливаем аббревиатуры в верхний регистр
