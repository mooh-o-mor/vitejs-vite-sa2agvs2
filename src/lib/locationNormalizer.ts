...
const WATER_BODY = /^(керченский пролив|балтийское море|охотское море|берингово море|японское море|каспийское море|черное море|азовское море|мыс борзовка)/i;
