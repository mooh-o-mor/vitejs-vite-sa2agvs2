...
function renderBar(
  ...
  if (hasOption && optionStartDate) {
    const displayOptStart = optionStartDate < yearStart ? yearStart : optionStartDate;
    const displayOptEnd = contractEnd > yearEnd ? yearEnd : contractEnd;
