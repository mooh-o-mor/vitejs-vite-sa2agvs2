...
const ECA_ZONES = [
  {
    name: "ECA — Норвежское море (NOx с 01.03.2026, SOx с 01.03.2027)",
    coords: [
      [62.0, 5.0],      // Start — стык с North Sea ECA (62°N)
      [63.8875, 0.3819], // Point 1 — 63°53'15"N 00°22'55"E
      [64.4331, 0.4861], // Point 2 — 64°25'59"N 00°29'10"E
      [64.8422, -0.0950], // Point 3 — 64°50'32"N 00°05'42"W
      [67.7625, -6.2583], // Point 4 — 67°45'45"N 06°15'30"W
      [70.25,  32.0667], // Limit — 70°15'00"N 32°04'00"E (граница с РФ)
      [70.25,  31.0],    // вдоль российской границы к берегу
      [69.0,   30.0],
      [62.0,   5.0],     // замыкаем
    ] as [number, number][],
  },
