...
export default function App() {
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", background:T.bg, minHeight:"100vh", color:T.text }}>
      ...
      {/* ── Шапка: единый flex-поток, перенос только если не влезает ── */}
      <div style={{ 
        display: "flex", 
        alignItems: "center",
        flexWrap: "wrap",
        ...
        {access !== "guest" && (
          <span style={{ fontSize: 11, color: "#bfdbfe", whiteSpace: "nowrap" }}>
            {access === "admin" ? "👤" : "👁"}
          </span>
        )}
        ...
        {isAdmin && activeTab === "gantt" && (
          <div style={{ position: "relative" }}>
            ...
            {showExportMenu && (
              <div style={{ position: "absolute", left: 0, top: "110%", background: T.bg2, border: `1px solid ${T.border}`, borderRadius: 8, padding: 16, zIndex: 50, width: 280, boxShadow: "0 8px 32px rgba(0,0,0,.15)" }}>
